 ...
 *  @Cr4bf04m
 *****************************************************************************/
#ifndef FF_MESH_PROXY_H
#define FF_MESH_PROXY_H

/**
 * @brief Initialize the mesh proxy services
 */
extern void ff_mesh_proxy_init();
 ...
 */
extern void ff_mesh_proxy_notify(uint16_t opcode, uint8_t *p_data, uint16_t len,
                                 uint8_t ttl);
