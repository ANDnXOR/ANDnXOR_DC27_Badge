...
/**
 * This is meant to be a shim between SHELL and USB CDC ACM driver in Zephyr. At
 * some point I expect them to support this natively but not as of now
 */
...
#include "autoconf.h"
#include "ff_shell_cdc_acm.h"

#define LOG_LEVEL 4
#include <logging/log.h>
LOG_MODULE_REGISTER(ff_shell_cdc_acm);
...
static int __init(const struct shell_transport* transport,
  ...
  __cdc_acm->dev = device_get_binding(CONFIG_CDC_ACM_PORT_NAME);
  ...
  char* welcome = "\033[2JWelcome to AND!XOR DC27\r\n";
 ...
 */
bool ff_shell_cdc_acm_is_connected() {
  return __connected;
}
